...
void setup() {
  ...
  //On doubt, just leave the standard pressure as default (1013.25 hPa);
    ...
    bme1.parameter.pressureSeaLevel = 1036.30;            //default value of 1013.25 hPa (Sensor 1)
    bme2.parameter.pressureSeaLevel = 1036.30;            //default value of 1013.25 hPa (Sensor 2)
    bme3.parameter.pressureSeaLevel = 1036.30;            //default value of 1013.25 hPa (Sensor 3)
    bme4.parameter.pressureSeaLevel = 1036.30;            //default value of 1013.25 hPa (Sensor 4)
